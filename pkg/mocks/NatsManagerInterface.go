...
func (_m *NatsManagerInterface) QueueSubscribe(_a0 string, _a1 string, _a2 nats_manager.MsgHandler, _a3 ...nats_manager.SubscriptionOption) (nats_manager.Subscription, error) {
	...
	if rf, ok := ret.Get(0).(func(string, string, nats_manager.MsgHandler, ...nats_manager.SubscriptionOption) nats_manager.Subscription); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, nats_manager.MsgHandler, ...nats_manager.SubscriptionOption) error); ok {
